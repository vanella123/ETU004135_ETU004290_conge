...
if (! function_exists('avatarClass')) {
    ...
    {
        $classes = ['av-green', 'av-blue', 'av-amber', 'av-purple'];
...
if (! function_exists('typeBadge')) {
    function typeBadge(string $libelle): string
    {
        ...
        if (str_contains($lib, 'annuel')) return '<span class="type-badge t-annuel">' . esc($libelle) . '</span>';
        if (str_contains($lib, 'maladie')) return '<span class="type-badge t-maladie">' . esc($libelle) . '</span>';
        if (str_contains($lib, 'spécial') || str_contains($lib, 'special')) return '<span class="type-badge t-special">' . esc($libelle) . '</span>';
